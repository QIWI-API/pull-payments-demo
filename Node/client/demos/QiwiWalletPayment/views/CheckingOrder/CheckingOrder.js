...
const CheckingOrder = (props) => {
    ...
    const nameGroup = 'qiwiWalletPayment';
        ...
        <div>
            ...
            <div className="checking-order__select-block">
                {RadioButtons.map((button, index)=>{
                    return (<RadioButton labelText={button.main} labelTextAdditional={button.additional} index={index} key={index} nameGroup={nameGroup}/>);
                })}
            </div>
